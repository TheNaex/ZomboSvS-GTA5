...
UpdateSkill = function(skill, amount)
	...
	if Config.Notifications and tonumber(amount) > 0 then
		--exports['Z-Notificacion']:Notify("success", "Habilidad", "+" .. amount .. " de experiencia en " .. skill, 2, true)
        QBCore.Functions.Notify("+" .. amount .. " de experiencia en " .. skill, 'success', 1000)		
	end
